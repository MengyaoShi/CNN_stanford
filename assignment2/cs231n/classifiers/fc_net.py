...
class TwoLayerNet(object):
    ...
    def __init__(self, input_dim=3*32*32, hidden_dim=100, num_classes=10,
        ...
        ############################################################################
        self.params['W1']=np.random.normal(0,weight_scale, input_dim*hidden_dim).reshape( input_dim,hidden_dim) # hidden_dim * input_dim, b1 has dimension= hidden_dim, W2 has num_classes * hidden_dim, b2 has num_classes 
    ...
    def loss(self, X, y=None):
        ...
        b1=self.params['b1']
        b2=self.params['b2']
        out_aff,cache_aff=affine_forward(X, W1, b1)
        out_relu,cache_relu=relu_forward(out_aff) 
        scores,cache_aff1=affine_forward(out_relu, W2, b2)
        ...
        ############################################################################
        dx1, dW2, db2=affine_backward(dx, cache_aff1)
        dW2+=self.reg*W2
        dx2=relu_backward(dx1, cache_relu)
        dx, dW1, db1=affine_backward(dx2, cache_aff)
        dW1+=self.reg*W1
        grads['W1']=dW1
        grads['W2']=dW2
        grads['b1']=db1
...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
        ...
        self.params['W'+str(self.num_layers)]=np.random.normal(0,weight_scale, hidden_dims[len(hidden_dims)-1]*num_classes).reshape(hidden_dims[len(hidden_dims)-1],num_classes)
    ...
    def loss(self, X, y=None):
        ...
        # of 0.5 to simplify the expression for the gradient.                      #
        ############################################################################
        dx, dW, db=affine_backward(dx, cache_aff)
